...
def make_default_iquise(apps, schema_editor):
    IQUISE = apps.get_model("website", "IQUISE")
    IQUISE.objects.create(description="test", default_time=time(11, 45))
