...
class Voter(models.Model):
    ...
    Once used, this token should be removed to avoid re-use.
    """
...
class Ballot(models.Model):
    ...
    def __unicode__(self):
        return "%s: %s" %(election, description)
...
class Nominee(models.Model):
    ...
    """
    ballots = models.ManyToManyField(Ballot) # TODO: limit_choices_to=ballots of current election?
